            ...
            {msg.media_url && (
              <div className="mb-1.5 -mx-3 -mt-2 first:mt-0">
                {isImageUrl(msg.media_url) ? (
                  ...
                  <div className="p-1">
                    <audio src={msg.media_url} controls preload="metadata" className="w-full h-10" style={{ maxWidth: "240px" }} />
                  </div>
                ) : (
                  <a href={msg.media_url} target="_blank" rel="noopener noreferrer"
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium truncate">{msg.media_url.split("/").pop() || "File"}</p>
